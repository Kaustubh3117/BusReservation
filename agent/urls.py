...
urlpatterns = [
    ...
    path('boading_point_crud/', BoardingPointCrudView.as_view(), name='boading_point_crud'),
    ...
    path('dropping_point/<int:user_id>', DroppingPointView.as_view(), name='dropping_point_crud'),
    path('dropping_point_crud/', DroppingPointCrudView.as_view(), name='dropping_point_crud'),
    path('dropping_point_crud/<int:pk>', DroppingPointCrudView.as_view(), name='boading_point_crud'),
