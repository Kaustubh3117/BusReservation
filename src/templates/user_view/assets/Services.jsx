    ...
    <div className="surface-0 text-center mt-3">
      ...
      <div className="grid">
        <div className="col-4 md:col-4 mb-4 px-5">
          ...
          <div className="text-xl mb-3 font-medium">Built for Developers</div>
        ...
        <div className="col-4 md:col-4 mb-4 px-5">
          ...
          <div className="text-xl mb-3 font-medium">End-to-End Encryption</div>
          <span className="text-lg line-height-3">
        ...
        <div className="col-4 md:col-4 mb-4 px-5">
          ...
          <div className="text-xl mb-3 font-medium">Easy to Use</div>
        ...
        <div className="col-4 md:col-4 mb-4 px-5">
          ...
          <div className="text-xl mb-3 font-medium">Fast & Global Support</div>
          <span className="text-lg text-sm line-height-3">
        ...
        <div className="col-4 md:col-4 md:mb-4 mb-0 px-3">
          ...
          <div className="text-xl mb-3 font-medium">Trusted Securitty</div>
          <span className="text-lg text-sm line-height-3">
